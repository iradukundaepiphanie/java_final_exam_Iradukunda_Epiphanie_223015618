...
<body>
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/student/grades" class="menu-item active">
    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <p style="color: #7f8c8d; margin-top: 5px;">View your academic performance</p>
        </div>
        
        <div class="section">
            <h2 style="margin-bottom: 25px;">Graded Assignments</h2>
            <c:choose>
                        ...
                        <tbody>
                            <c:forEach var="grade" items="${grades}">
                                <tr>
                                    ...
                                    <td class="grade-score grade-a">${grade.score}</td>
                                    <td>${grade.maxPoints}</td>
                                    <td>
                                        <c:set var="percentage" value="${(grade.score / grade.maxPoints) * 100}" />
