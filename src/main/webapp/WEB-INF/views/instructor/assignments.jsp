...
<head>
    ...
    <title>Manage Assignments - Instructor</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <p style="color: #7f8c8d; margin-top: 5px;">Create and manage course assignments</p>
        </div>
        
        <div class="section">
            <div class="course-selector">
                <label for="courseSelect"><strong>Select Course:</strong></label><br><br>
                <select id="courseSelect" onchange="window.location.href='${pageContext.request.contextPath}/instructor/assignments?courseId=' + this.value">
            ...
            <c:if test="${not empty course}">
                <h3>Assignments for ${course.courseName}</h3>
                <a href="${pageContext.request.contextPath}/instructor/create-assignment?courseId=${course.courseID}" class="btn-add">
            ...
            <c:if test="${empty course && not empty param.courseId}">
                <div class="no-data">
