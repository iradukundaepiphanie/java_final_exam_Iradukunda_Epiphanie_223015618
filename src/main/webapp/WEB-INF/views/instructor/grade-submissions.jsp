...
<head>
    ...
    <title>Grade Submissions - Instructor</title>
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <h1><i class="fas fa-check-circle"></i> Grade Submissions</h1>
            <p style="color: #7f8c8d; margin-top: 5px;">Review and grade student assignment submissions</p>
        </div>

        <div class="section">
            <h2 style="margin-bottom: 25px;">Assignments with Submissions</h2>
            <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/instructor/view-submissions?assignmentId=${assignment.assignmentID}" class="action-link">
                                            <i class="fas fa-eye"></i> View Submissions (${assignment.submissionCount})
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <c:otherwise>
                    <div class="no-data">
                        ...
                        <p>No assignments have student submissions yet.</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
